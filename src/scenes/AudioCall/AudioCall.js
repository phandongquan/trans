...
import { getListAudio, updateTextAudio, deleteAudio } from '~/apis/audiocall';
...
class AudioCall extends Component {
    ...
    getListFile = async (params = {}) => {
        ...
        let response = await getListAudio(params)
        if (response) {
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslation()(AudioCall));