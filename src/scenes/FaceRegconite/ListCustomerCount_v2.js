...
import { getESLog, getReturningRate } from '~/apis/aiFaceLog';


const { RangePicker } = DatePicker;

export class ListCustomerCount_v2 extends Component {
    constructor(props) {
        super(props)
...
export default connect(mapStateToProps, mapDispatchToProps)(ListCustomerCount_v2)