...
import { getReportCheckoutList, getESLog } from '~/apis/aiFaceLog/index_v3'


const { RangePicker } = DatePicker;

export class HistoryCashierUse_v3 extends Component {
    constructor(props) {
        super(props)
...
export default connect(mapStateToProps, mapDispatchToProps)(HistoryCashierUse_v3)