...
import { faPlus, faPen, faFolder, faTrash, faEllipsisV, faList, faMusic, faVideo, faMinusCircle, faCheck, faCheckCircle, faMinusSquare, faPlayCircle, faPauseCircle } from '@fortawesome/free-solid-svg-icons';
...
export class AdvertisementVideo extends Component {
    ...
    async getList(params = {}) {
        ...
        let response = await getListAdvertisement(values, 2);
        if (response.status) {
    ...
    render() {
        ...
        const columns = [
            ...
            },
            {
                title: t('file'),
                render: r => {
                    return <a href={r.file} target="_blank">{
        ...
        return (
            <>
                <PageHeader
                    title={t('hr:video')}
                    tags={
                        checkPermission('hr-log-video-create') ?
...
export default connect(mapStateToProps, mapDispatchToProps)(AdvertisementVideo)